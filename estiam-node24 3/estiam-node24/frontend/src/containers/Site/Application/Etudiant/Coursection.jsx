...
import Calendar from '../Intervenant/Calendar'; // Assurez-vous que le chemin d'importation est correct
import 'react-calendar/dist/Calendar.css'; // Importez le CSS pour le calendrier

function CourseSection({ onCoursesChange }) { // Ajoutez `onCoursesChange` comme prop
  ...
  // Convertir les dates des cours en tableau de dates pour marquage
  const markedDates = courses.map(course => new Date(course.date));

  // Fonction pour vérifier si une date est marquée
